...
class _bpMenu {
	...
	public function add_page() {
		add_menu_page(
			...
			$this->slug,
			[$this, 'render_admin'],
			'data:image/svg+xml;base64,' . base64_encode(_PLUGIN_BASIC_PTL_ICON),
			3
		);
